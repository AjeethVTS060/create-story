...
// import "./TermsAndCondition.css"; // Importing the CSS for styling
...
//           use of InterAIview's Website, located at [Your Website URL].
//         </p>
//         <p>
//           By accessing this website we assume you accept these terms and
//           conditions. Do not continue to use InterAIview if you do not agree to
//           take all of the terms and conditions stated on this page.
//         </p>
//         <h2>Cookies</h2>
//         <p>
//           We employ the use of cookies. By accessing InterAIview, you agreed to
//           use cookies in agreement with InterAIview's Privacy Policy.
//         </p>
//         <p>
...
//         <h2>License</h2>
//         <p>
//           Unless otherwise stated, InterAIview and/or its licensors own the
//           intellectual property rights for all material on InterAIview. All
//           intellectual property rights are reserved. You may access this from
//           InterAIview for your own personal use subjected to restrictions set
//           in these terms and conditions.
//         </p>
//         <p>You must not:</p>
//         <ul>
//           <li>Republish material from InterAIview</li>
//           <li>Sell, rent or sub-license material from InterAIview</li>
//           <li>Reproduce, duplicate or copy material from InterAIview</li>
//           <li>Redistribute content from InterAIview</li>
//         </ul>
...
const TermsAndConditions = ({ headingText = "Terms And Conditions" }) => {
  const [isChecked, setIsChecked] = useState(false);
...
<ul>
  ...
  <li>
    ...
    refers to Career Iq, Toronto, Canada.
  </li>
  <li>
  ...
  <li>
    <strong>Website</strong> refers to Career Iq, accessible from https://careeriq.com
  </li>
  <li>
...
<p>
  ...
  under this Terms shall not affect a party's ability to exercise such right or require such performance at
...
<ul>
  ...
  <li>By phone number: 408.996.1010</li>
          ...
          <button className="accept-button" disabled={!isChecked}>
            <Link to="/">Accept</Link>
          </button>
        </ContentWithPaddingXl>
      </Container>
